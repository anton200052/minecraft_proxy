...
@Component
public class PingRequestPacketParserV754 extends PingRequestPacketParser {

    public PingRequestPacketParserV754(PacketDataCodec packetDataCodec) {
        super(packetDataCodec);
    }

    @Override
    protected Packet parseSpecific(int packetId, PacketDirection packetDirection, long timestamp) {
        return new PingRequestPacketV754(packetId, timestamp);
    }
